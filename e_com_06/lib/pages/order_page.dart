                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          ...
                          const SizedBox(height: 5,),
                          Text('$currencySymbols${provider.getTotalSaleBySingleDate(DateTime.now())}',  style: Theme.of(context).textTheme.headline5,)
                        ],
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          const Text('Total Sale'),
                          const SizedBox(height: 5,),
                          Text('$currencySymbols${provider.getTotalSaleBySingleDate(DateTime.now().subtract(const Duration(days: 1)))}',  style: Theme.of(context).textTheme.headline5,)
                        ],
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          const Text('Total Sale'),
                          const SizedBox(height: 5,),
                          Text('$currencySymbols${provider.getTotalSaleByWeek(DateTime.now().subtract(const Duration(days: 7)))}',  style: Theme.of(context).textTheme.headline5,)
                        ],
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          const Text('Total Sale'),
                          const SizedBox(height: 5,),
                          Text('$currencySymbols${provider.getTotalSaleByDateRange(DateTime.now())}',  style: Theme.of(context).textTheme.headline5,)
                        ],
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          const Text('Total Sale'),
                          const SizedBox(height: 5,),
                          Text('$currencySymbols${provider.getTotalAllTimeSale()}',  style: Theme.of(context).textTheme.headline5,)
                        ],
                      ),
                    ],
                  ),
